...
RESOURCES += src/qt/nodezero.qrc src/qt/nodezero_locale.qrc

TRANSLATIONS += src/qt/locale/nodezero_bg.ts \
                src/qt/locale/nodezero_de.ts \
                src/qt/locale/nodezero_en.ts \
                src/qt/locale/nodezero_es.ts \
                src/qt/locale/nodezero_fi.ts \
                src/qt/locale/nodezero_fr.ts \
                src/qt/locale/nodezero_it.ts \
                src/qt/locale/nodezero_ja.ts \
                src/qt/locale/nodezero_pl.ts \
                src/qt/locale/nodezero_pt.ts \
                src/qt/locale/nodezero_ru.ts \
                src/qt/locale/nodezero_sk.ts \
                src/qt/locale/nodezero_sv.ts \
                src/qt/locale/nodezero_vi.ts \
                src/qt/locale/nodezero_zh_CN.ts \
                src/qt/locale/nodezero_zh_TW.ts
