...
In order to support loading of multiple wallets in nodezero-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodezero.cpp.
...
Changes to nodezero.cpp
----------------------
nodezero.cpp is the entry point into nodezero-qt, and as such, will require some minor modifications to provide hooks for
