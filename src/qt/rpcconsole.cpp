                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzNZRPathCustom = GetArg("-zNZRbackuppath", "");
    ...
    if(!strzNZRPathCustom.empty()) {
        ui->wallet_customzNZRbackuppath->setText(QString::fromStdString(strzNZRPathCustom));
        ui->wallet_customzNZRbackuppath_label->setVisible(true);
        ui->wallet_customzNZRbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzNZRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the NodeZero RPC console.") + "<br>" +
