...
/** Utility functions used by the NodeZero Qt UI.
 */
namespace GUIUtil
{
...
// Render NodeZero addresses in monospace font
...
// Parse "nodezero:" URI into recipient object, return true on successful parsing
