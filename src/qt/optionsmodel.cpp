...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::NZR);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeNZRAmount"))
        SoftSetArg("-anonymizeNZRamount", settings.value("nAnonymizeNZRAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in nodezero.cpp during shutdown to also remove the window positions
