...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NodeZero Core"),
     ...
     * override -datadir in the nodezero.conf file in the default data directory
     * (to be consistent with nodezerod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
