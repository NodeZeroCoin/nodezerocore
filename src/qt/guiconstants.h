...
/* NodeZero GUI -- Size of icons in status bar */
...
#define COLOR_STAKE QColor(0,56,102)
...
#define QAPP_ORG_NAME "NodeZero"
#define QAPP_ORG_DOMAIN "nodezeroplatform.com"
#define QAPP_APP_NAME_DEFAULT "nodezero-qt"
#define QAPP_APP_NAME_TESTNET "nodezero-qt-testnet"
