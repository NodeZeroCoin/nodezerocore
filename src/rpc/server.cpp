...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop NodeZero server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "NodeZero server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NodeZero features */
        {"nodezero", "listmasternodes", &listmasternodes, true, true, false},
        {"nodezero", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodezero", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodezero", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nodezero", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nodezero", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nodezero", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodezero", "masternodedebug", &masternodedebug, true, true, false},
        {"nodezero", "startmasternode", &startmasternode, true, true, false},
        {"nodezero", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodezero", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodezero", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodezero", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodezero", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodezero", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodezero", "preparebudget", &preparebudget, true, true, false},
        {"nodezero", "submitbudget", &submitbudget, true, true, false},
        {"nodezero", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodezero", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodezero", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodezero", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodezero", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodezero", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodezero", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodezero", "checkbudgets", &checkbudgets, true, true, false},
        {"nodezero", "mnsync", &mnsync, true, true, false},
        {"nodezero", "spork", &spork, true, true, false},
        {"nodezero", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzNZRseed", &getzNZRseed, false, false, true},
        {"zerocoin", "setzNZRseed", &setzNZRseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzNZR", &searchdzNZR, false, false, true},
        {"zerocoin", "dzNZRstate", &dzNZRstate, false, false, true},
...
{
    return "> nodezero-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52270/\n";
}
