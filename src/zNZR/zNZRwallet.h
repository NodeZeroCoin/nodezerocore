...
#ifndef NZR_ZNZRWALLET_H
#define NZR_ZNZRWALLET_H
...
public:
    CzNZRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZNZR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZNZR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
