...
#ifndef NZR_ZNZRTRACKER_H
#define NZR_ZNZRTRACKER_H
...
public:
    CzNZRTracker(std::string strWalletFile);
    ~CzNZRTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNZRWallet* zNZRWallet = NULL);
