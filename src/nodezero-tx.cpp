...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NodeZero Core nodezero-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodezero-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodezero transaction") + "\n" +
                               "  nodezero-tx [options] -create [commands]   " + _("Create hex-encoded nodezero transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodezero transaction
