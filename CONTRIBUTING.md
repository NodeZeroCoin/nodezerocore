Contributing to NodeZero Core
============================

The NodeZero Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NodeZero Core project, and is not to be
confused with overall NodeZero Network Protocol consensus changes.

Whether a pull request is merged into NodeZero Core rests with the project merge
...
Patches that change NodeZero consensus rules are considerably more involved than
...
Where a patch set proposes to change the NodeZero consensus, it must have been
...
The project leader is the release manager for each NodeZero Core release.
